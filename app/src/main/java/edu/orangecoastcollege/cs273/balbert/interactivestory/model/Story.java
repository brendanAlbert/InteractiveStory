package edu.orangecoastcollege.cs273.balbert.interactivestory.model;

import edu.orangecoastcollege.cs273.balbert.interactivestory.R;

/**
 * Created by brendantyleralbert on 9/29/17.
 */
...
public class Story {
    ...
    public Page getPage(int pageNumber) {
        return pages[ pageNumber >= pages.length ? 0 : pageNumber ];
    }
}
